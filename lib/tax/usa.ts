...
const setups: Setup[] = [
  {
    ...
    type: 'deferred',
    fees: 'USD 7,500 limit (2026), USD 8,600 age 50+. Deductible (income limits apply), tax-deferred growth, taxed withdrawals (EET).',
    penaltyRate: 0.1,
    thresholdAge: 59.5,
  },
  {
    name: 'Roth IRA',
    type: 'taxfree',
    fees: 'USD 7,500 limit (2026), USD 8,600 age 50+. After-tax, tax-free growth and qualified withdrawals (TEE). No RMDs.',
    penaltyRate: 0.1,
    thresholdAge: 59.5,
  },
  {
    ...
    type: 'deferred',
    fees: 'USD 24,500 limit (2026), USD 32,500 age 50+. Pre-tax contributions, tax-deferred growth, taxed on withdrawal (EET).',
    penaltyRate: 0.1,
    thresholdAge: 59.5,
  },
  {
    name: '401k Roth',
    type: 'taxfree',
    fees: 'USD 24,500 limit (2026), USD 32,500 age 50+. After-tax contributions, tax-free growth and qualified withdrawals (TEE).',
    penaltyRate: 0.1,
    thresholdAge: 59.5,
  },
  {
